            ...
            <div class="row">
                <div class="col-lg-6 col-md-6">
                    <div class="single-product-item">
                        <figure>
                            <img src="{{ url('public') }}/img/gmbr 6.jpg" alt="">
                            <div class="p-status">new</div>
                            <div class="hover-icon">
                                <a href="{{ url('public') }}/img/gmbr 6.jpg" class="pop-up"><img src="{{ url('public') }}/img/icons/zoom-plus.png"
                                        alt=""></a>
                            </div>
                        </figure>
                ...
                <div class="col-lg-6 col-md-6">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6">
                            <div class="single-product-item">
                                <figure>
                                    <img src="{{ url('public') }}/img/gmbr 8.jpg" alt="">
                                    <div class="p-status">new</div>
                                    <div class="hover-icon">
                                        <a href="{{ url('public') }}/img/gmbr 4.jpg" class="pop-up"><img
                                                src="{{ url('public') }}/img/gmbr 4.jpg" alt=""></a>
                                    </div>
                                </figure>
                                <div class="product-text">
                                    <a href="#">
                        ...
                        <figure>
                            ...
                            <div class="hover-icon">
                                <a href="{{ url('public') }}/img/products/img-8.jpg" class="pop-up"><img src="{{ url('public') }}/img/icons/zoom-plus.png"
                                        alt=""></a>
                            </div>
                        </figure>
                        <div class="product-text">
